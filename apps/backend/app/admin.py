...
from .models import (
    User, Artist, Transaction, Purchase, Style, Artwork,
    Generation, Tag, StyleTag, ArtworkTag, GenerationTag,
    Follow, Like, Comment, Notification
)
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('id', 'username', 'provider', 'role', 'token_balance', 'is_active', 'created_at')
...
class ArtistAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'user', 'artist_name', 'earned_token_balance', 'follower_count', 'created_at')
...
class StyleAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'name', 'artist', 'training_status', 'generation_cost_tokens', 'usage_count', 'is_active')
...
class GenerationAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'user', 'style', 'status', 'consumed_tokens', 'is_public', 'like_count', 'created_at')
