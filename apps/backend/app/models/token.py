    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                check=models.Q(transaction_type__in=['purchase', 'generation', 'withdrawal', 'transfer']),
        ...
        indexes = [
            models.Index(fields=['sender', '-created_at'], name='idx_transactions_sender'),
            models.Index(fields=['receiver', '-created_at'], name='idx_transactions_receiver'),
            models.Index(fields=['transaction_type', '-created_at'], name='idx_transactions_type'),
            models.Index(fields=['related_style'], name='idx_transactions_style'),
            models.Index(fields=['related_generation'], name='idx_transactions_generation'),
            models.Index(fields=['status', '-created_at'], name='idx_transactions_status'),
        ]
...
class Purchase(models.Model):
    ...
    provider_total_amount = models.DecimalField(max_digits=18, decimal_places=2, null=True, blank=True)
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                check=models.Q(amount_tokens__gt=0),
                name='amount_tokens_positive'
            ),
            models.CheckConstraint(
