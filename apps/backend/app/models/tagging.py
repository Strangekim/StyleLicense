    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['style', 'tag'],
                name='unique_style_tag'
            ),
            models.UniqueConstraint(
                fields=['style', 'sequence'],
                name='unique_style_sequence'
            ),
        ]
        indexes = [
...
class ArtworkTag(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['artwork', 'tag'],
                name='unique_artwork_tag'
            ),
            models.UniqueConstraint(
                fields=['artwork', 'sequence'],
                name='unique_artwork_sequence'
            ),
        ]
        indexes = [
...
class GenerationTag(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['generation', 'tag'],
                name='unique_generation_tag'
            ),
            models.UniqueConstraint(
                fields=['generation', 'sequence'],
                name='unique_generation_sequence'
            ),
        ]
        indexes = [
